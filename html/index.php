		...
		if(roomData['mode'] == 'lobby') {
			for (var i = 1; i < roomNumber + 1; i++){
				if(roomData[i]['user2_id'] == null && roomData[i]['user1_id'] != null) {
					document.getElementById('waiting' + i).innerHTML = roomData[i]['user1_id'];
					...
					document.getElementById('waiting' + i).innerHTML = ''; //roomData[i]['user1_id'] + ' VS ' + roomData[i]['user2_id'];
					...
					document.getElementById('waiting' + i).innerHTML = '';
